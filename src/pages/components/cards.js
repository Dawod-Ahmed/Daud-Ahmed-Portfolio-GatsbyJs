...
const card = (props) => {
  const { claasname, title, title1, para, projects } = props;
  return (
   
      <div
        className={`cards-parent ${claasname} d-flex flex-column justify-content-start  align-items-center my-3 mx-4`}
      >
        <div className={`card-img ${claasname}-img `}></div>
